...
/***/ function(module, exports, __webpack_require__) {
	...
	var _narwhal = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"narwhal\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	
	var _actions = __webpack_require__(161);
	
	var _actionHandler = __webpack_require__(163);
	...
	var store = (0, _narwhal.createStore)(data, _actionHandler2.default);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    case _constants.ADD_TODO:
	      {
	        ...
	        if (!findTodo({ state: state, name: name })) {
	          state.todos.push({
	            name: name,
	            complete: false
	          });
	...
	function findTodo(_ref) {
	  var name = _ref.name;
	  var state = _ref.state;
	
	  return state.todos.find(function (todoName) {
